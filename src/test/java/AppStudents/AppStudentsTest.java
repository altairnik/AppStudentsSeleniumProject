...
public class AppStudentsTest {
    ...
    //driver.findElement(By.cssSelector("div.main-content input#icon_prefix")).sendKeys(UUID.randomUUID().toString());
    ...
    //driver.findElement(By.cssSelector("div.main-content input#icon_telephone")).sendKeys(((Long) System.currentTimeMillis()).toString());
